/**
 * This is a clone of pdf-image npm module fixed to work in Windows env
 * (imagemagick command has beed edited)
 * */
...
PDFImage.prototype = {
  ...
  constructConvertCommandForPage: function (pageNumber) {
    ...
    return util.format(
      "%s %s %s[%d] %s",
      this.useGM ? "gm convert" : "magick.exe convert",
